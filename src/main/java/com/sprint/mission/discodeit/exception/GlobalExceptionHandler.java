...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleIllegalTokenException(IllegalTokenException exception) {
    ...
    private HttpStatus determineHttpStatus(DiscodeitException exception) {
        ...
        return switch (errorCode) {
            case INVALID_USER_AUTHORIZATION -> HttpStatus.FORBIDDEN;
            ...
            case INVALID_USER_CREDENTIALS, ILLEGAL_TOKEN_ERROR -> HttpStatus.UNAUTHORIZED;
